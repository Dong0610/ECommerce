...
class AddDataActivity : BaseActivity<ActivityAddDataBinding>() {
    ...
    override fun createView() {
        ...
        binding.addManufac.setOnClickListener {
            putManafactural()
        }
    ...
    private fun putPaymenthod(resource: Int, callback: (String) -> Unit) {
        storage.getReference("Payment_Medthod")
            .putImgToStorage(
                uri_from_drawable(this, resource)!!,
    ...
    private fun putManafactural() {
        putShopToFirebase {
            it.forEach { item ->
                ...
                hasmap[Constant.SHOP_MANAFACT_IMG] = item.imageUrl.toString()
        ...
        val listProduct = mutableListOf(
            Product(
                ...
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh " +
                        ...
                        "trong khi các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở.","CD0113-400",0,0,0.0f,0f
            ),
            Product(
                ...
                InitData.listPutData.get(0).nameManu,
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh " +
                        "của trò chơi ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt " +
                        "vời trong khi các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở.","CD0113-400",
                0,0,0.0f,0f
            ...
            Product(
                ...
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp " +
                        "độ nhanh của trò chơi ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo" +
                        " cảm giác tuyệt vời trong khi các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",0,0,0.0f,0f
            ),
            Product(
                ...
                InitData.listPutData.get(1).idManu,
                InitData.listPutData.get(1).nameManu,
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh của " +
                        "trò chơi ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt vời trong" +
                        " khi các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
                ...
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh " +
                        "của trò chơi ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt " +
                        "vời trong khi các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
            ...
            Product(
                ...
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh của trò chơi ngày" +
                        " nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt vời trong khi các lỗ đục ở mũi " +
                        "giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
                ...
                InitData.listPutData.get(3).idManu,
                InitData.listPutData.get(3).nameManu,
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh của trò" +
                        " chơi ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt vời trong khi " +
                        "các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
            ...
            Product(
                ...
                InitData.listPutData.get(4).nameManu,
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh của" +
                        " trò chơi ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt vời " +
                        "trong khi các lỗ đục ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
            ...
            Product(
                ...
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh của trò chơi" +
                        " ngày nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt vời trong khi các lỗ đục" +
                        " ở mũi giày và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
            ...
            Product(
                ...
                "Yêu thích kiểu dáng cổ điển của bóng rổ thập niên 80 nhưng bạn có thích văn hóa nhịp độ nhanh của trò chơi ngày" +
                        " nay không? Cổ giày có đệm, kiểu dáng cắt thấp trông bóng bẩy và tạo cảm giác tuyệt vời trong khi các lỗ đục ở mũi giày" +
                        " và hai bên tạo thêm sự thoải mái và dễ thở."
                ,"CD0113-400",   0,0,0.0f,0f
            ),
            Product(
                "HJwm1eFo4vu95mwtcruu",
    ...
    private fun addToDb(product: Product) {
        ...
        hashMap[Constant.PRODUCT_EVALUATION]= product.evaluation
        hashMap[Constant.PRODUCT_IS_SALE] = true
        hashMap[Constant.PRODUCT_COUNTBUY] = product.countBuy
        hashMap[Constant.PRODUCT_TAX]= product.tax
        hashMap[Constant.PRODUCT_TRANSMONEY] = product.transMoney
